  ...
  return (
    <div className="navbar bg-base-100 relative">
      ...
      <div className="flex-1 flex justify-center items-center">
        <a className="text-xl font-semibold">{data.room_name}</a>
      </div>
      <div className="flex-none">
      ...
      {isBannerOpen && (
        ...
        >
          <div className="flex flex-col items-center p-4 mt-6">
            ...
            <h2 className="text-xl font-semibold mb-1">{data.room.room_name}</h2>
            <p className="text-sm text-gray-500 mb-4">{data.hashtags}</p>
            ...
            <li>
              <button onClick={toggleBanner}>
                  <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <line x1="1.03531" y1="19.2938" x2="21.2938" y2="0.96469" stroke="black" strokeLinecap="round" strokeWidth="3px" />
                    <line x1="21.2938" y1="19.2938" x2="1.03531" y2="0.96469" stroke="black" strokeLinecap="round" strokeWidth="3px"/>
                  </svg>
              </button>
            </li>
